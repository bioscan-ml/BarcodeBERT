...
def run(config):
    ...
    X_test = representations_from_df(test_filename, embedder, batch_size=128, dataset=config.dataset_name)["data"]
    ...
    X_val = representations_from_df(validation_filename, embedder, batch_size=128, dataset=config.dataset_name)["data"]
